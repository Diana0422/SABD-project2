...
public class Query3Result implements FlinkResult {
    ...
    public String toStringCSV() {
        return timestamp.toString()+","
                +cell0.getId()+","
                +avgTemp0.toString()+","
                +medianTemp0.toString()+","
                +cell1.getId()+","
                +avgTemp1.toString()+","
                +medianTemp1.toString()+","
                +cell2.getId()+","
                +avgTemp2.toString()+","
                +medianTemp2.toString()+","
                +cell3.getId()+","
                +avgTemp3.toString()+","
                +medianTemp3.toString()+","
                +cell4.getId()+","
                +avgTemp4.toString()+","
                +medianTemp4.toString()+","
                +cell5.getId()+","
                +avgTemp5.toString()+","
                +medianTemp5.toString()+","
                +cell6.getId()+","
                +avgTemp6.toString()+","
                +medianTemp6.toString()+","
                +cell7.getId()+","
                +avgTemp7.toString()+","
                +medianTemp7.toString()+","
                +cell8.getId()+","
                +avgTemp8.toString()+","
                +medianTemp8.toString()+","
                +cell9.getId()+","
                +avgTemp9.toString()+","
                +medianTemp9.toString()+","
                +cell10.getId()+","
                +avgTemp10.toString()+","
                +medianTemp10.toString()+","
                +cell11.getId()+","
                +avgTemp11.toString()+","
                +medianTemp11.toString()+","
                +cell12.getId()+","
                +avgTemp12.toString()+","
                +medianTemp12.toString()+","
                +cell13.getId()+","
                +avgTemp13.toString()+","
                +medianTemp13.toString()+","
                +cell14.getId()+","
                +avgTemp14.toString()+","
                +medianTemp14.toString()+","
                +cell15.getId()+","
                +avgTemp15.toString()+","
                +medianTemp15.toString()+"\n";
    }
}
