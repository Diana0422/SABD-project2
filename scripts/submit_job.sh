...
then
  ...
  docker exec -t -i jobmanager flink run -p $2 -c com.diagiac.flink.query1.Query1 ./sensor-app/sabd2-flink-1.0-jar-with-dependencies.jar $3
elif [[ $1 -eq 2 ]]
then
  echo "Submitting query 2 to Flink"
  docker exec -t -i jobmanager flink run -p $2 -c com.diagiac.flink.query2.Query2 ./sensor-app/sabd2-flink-1.0-jar-with-dependencies.jar $3
elif [[ $1 -eq 3 ]]
then
